...
package fkpulsarreceiver // import "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/pulsarreceiver"
...
func NewFactory(options ...FactoryOption) receiver.Factory {
	...
	return receiver.NewFactory(
		Type,
		createDefaultConfig,
		receiver.WithTraces(f.createTracesReceiver, TracesStability),
		receiver.WithMetrics(f.createMetricsReceiver, MetricsStability),
		receiver.WithLogs(f.createLogsReceiver, LogsStability),
	)
}
